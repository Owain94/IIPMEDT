...
class Disk:
    ...
    def get_product_index_v2(potential_number: float) -> int:
        """
        Je zou maar een docent hebben die je draaischijf afkraakt. Ja....
        Dan moet het zo maar, blijkbaar moet een prototype perfect zijn.

        Nu jij nog...

        :param potential_number:potential waarde.
